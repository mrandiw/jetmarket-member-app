...
//                             text: item.text,
//                             senderName:
//                                 AppPreference().getUserData()?.user?.name,
...
//                       onTapCancel: () =>
//                           controller.selectedCancelChatDelet(item),
//                       timeWidget: newDate.isNotEmpty && newDate != 'Today'
...
//                   if (snapshot.hasData) {
//                     controller.scroolToNewChat();
//                   } else {}
//                   return ListView.separated(
//                       shrinkWrap: true,
//                       physics: const NeverScrollableScrollPhysics(),
//                       padding: EdgeInsets.only(bottom: 72.hr, top: 12.hr),
//                       itemBuilder: (_, index) {
//                         var item = snapshot.data?[index];
//                         bool isSender = item?.sender?.role ==
//                             controller.dataArgument?.fromRole;
//                         bool isReplySender = item?.pinnedMessage?.role ==
//                             controller.dataArgument?.fromRole;
...
//                         if (index == 0 && snapshot.data?.length == 1) {
//                           newDate = controller
//                               .groupMessageDateAndTime(
//                                   item?.createdAt?.formatCreatedAt ?? '')
//                               .toString();
//                         } else if (index == (snapshot.data?.length ?? 0) - 1) {
//                           newDate = controller
//                               .groupMessageDateAndTime(
//                                   item?.createdAt?.formatCreatedAt ?? '')
//                               .toString();
//                         } else {
//                           final DateTime date =
//                               controller.returnDateAndTimeFormat(
//                                   item?.createdAt?.formatCreatedAt ?? '');
//                           final DateTime prevDate =
//                               controller.returnDateAndTimeFormat(snapshot
//                                       .data?[index + 1]
//                                       .createdAt
//                                       ?.formatCreatedAt ??
//                                   '');
...
//                               ? ''
//                               : controller
//                                   .groupMessageDateAndTime(snapshot.data?[index]
