    ...
    return GetBuilder<WithdrawController>(builder: (controller) {
      return ListView(
        ...
        children: [
          ...
          Gap(12.h),
          Text('Biaya Layanan: Rp 2.500', style: text12BlackRegular),
          Gap(6.h),
          Text(
              'Saldo yang dibayarkan: ${'${int.parse(controller.nominalController.text.isNotEmpty ? controller.nominalController.text.replaceAll(',', '') : '0') + 2500}'.toIdrFormat}',
              style: text12BlackRegular),
          Gap(12.h),
          AppButton.primary(
