...
class DetailRefundSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RincianRefundController>(builder: (controller) {
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Gap(20.h),
        GestureDetector(
          onTap: () =>
              controller.toStore(controller.detailRefund?.seller?.id ?? 0),
          child: Row(
            children: [
              CachedNetworkImage(
              ...
              (index) => Padding(
                ...
                child: CachedNetworkImage(
                  ...
                  errorWidget: (context, url, error) {
                    return GestureDetector(
                      onTap: () {
                        controller.setSelectedProofsIndex(
                            index,
                            controller
                                    .detailRefund?.proofs?[index].description ??
                                '');
                      },
                      child: Container(
                        height: 66.r,
