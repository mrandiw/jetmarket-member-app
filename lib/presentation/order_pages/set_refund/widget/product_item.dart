...
import 'package:jetmarket/domain/core/model/model_data/set_refund_model.dart';
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text('${data?.price ?? data?.price}'.toIdrFormat,
                      style: text12PrimaryMedium),
                  const Spacer(),
                  Text("${data?.quantity}x", style: text12BlackRegular),
                  Gap(16.wr)
                ],
              ),
            ],
