...
class PaymentSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChoicePaymentPaylaterController>(builder: (controller) {
      return ListView(
                          ...
                          children: List.generate(
                              controller.paymentMethodes!.virtualAccount!
                                  ...
                                  : controller.paymentMethodes!.virtualAccount!
                                      .length, (index) {
                        if (index == 2 &&
                            controller.paymentMethodes!.virtualAccount!.length >
                                3) {
                          return Container(
                            height: 26.h,
                            width: 44.w,
                          ...
                          (index) => GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    boxShadow: [AppStyle.boxShadowSmall]),
                                child: Image.asset(
                                  controller.getImage(controller.paymentMethodes
                                          ?.virtualAccount?[index].chCode ??
                                      ''),
                                  fit: BoxFit.contain,
                                  height: 24.h,
              ...
              child: ExpansionTile(
                ...
                title: Row(
                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      child: Row(
                          children: List.generate(
                              controller.paymentMethodes!.ewalletQr!.length >= 3
                                  ? 2
                                  : controller
                                          .paymentMethodes?.ewalletQr?.length ??
                                      0, (index) {
                        if (index == 1 &&
                            controller.paymentMethodes!.ewalletQr!.length > 1) {
                          return Container(
                            height: 26.h,
                            width: 44.w,
                            decoration: BoxDecoration(
                ...
                children: [
                  Wrap(
                      ...
                      spacing: 6.r,
                      children: List.generate(
                          controller.paymentMethodes?.ewalletQr?.length ?? 0,
                          (index) {
                        // String assets = index ==
                        ...
                        return Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                boxShadow: [AppStyle.boxShadowSmall]),
                            child: Image.asset(controller.assetImage(controller
                                    .paymentMethodes?.otc?[index].chCode ??
                                '')),
                          ),
                        );
                      })),
