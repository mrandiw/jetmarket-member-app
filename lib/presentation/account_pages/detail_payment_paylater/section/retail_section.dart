            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(controller.waitingPayment?.channel?.code ?? '',
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text(controller.waitingPayment?.otc?.code ?? '',
                          ...
                          Gap(4.h),
                          Text(controller.waitingPayment?.otc?.name ?? '',
                              style: text14BlackMedium),
                        ],
                      ),
                      SizedBox(
                          ...
                          child: SfBarcodeGenerator(
                            value: controller.waitingPayment?.otc?.code ?? '',
                            showValue: true,
