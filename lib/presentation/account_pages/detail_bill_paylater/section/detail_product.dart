          ...
          children: [
            ...
            Column(
                children: List.generate(
                    controller.detailBillPaylater?.products?.length ?? 0,
                    (index) {
              return Padding(
                ...
                child: Card(
                  ...
                  child: ListTile(
                    leading: CachedNetworkImage(
                      imageUrl: controller
                              .detailBillPaylater?.products?[index].image ??
                          '',
                    ...
                    title: Text(
                        controller.detailBillPaylater?.products?[index].name ??
                            '',
                        style: text12BlackMedium),
                    subtitle: Text(
                        '${controller.detailBillPaylater?.products?[index].quantity} x ${controller.detailBillPaylater?.products?[index].price.toString().toIdrFormat}',
