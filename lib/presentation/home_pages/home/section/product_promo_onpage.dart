...
class ProductPromoOnPageSection extends StatelessWidget {
  const ProductPromoOnPageSection({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return SliverPadding(
      ...
      sliver: PagedSliverGrid<int, Product>(
        ...
        pagingController: controller.pagingPromoController,
