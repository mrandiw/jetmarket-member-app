...
class ProductPopularOnPageSection extends StatelessWidget {
  const ProductPopularOnPageSection({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return SliverPadding(
      ...
      sliver: PagedSliverGrid<int, Product>(
        ...
        pagingController: controller.pagingPopularController,
