      ...
      children: [
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                        "${controller.paymentCustomer?.channel?.code ?? 'BCA'} Virtual Account",
              ...
              SizedBox(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Virtual Account Number', style: text12BlackRegular),
                      Gap(4.h),
                      Row(
                        children: [
                          Text(
        ...
        SizedBox(
            ...
            child: TabBarView(
                ...
                children: const [AtmSection(), AtmSection(), AtmSection()]))
      ],
    );
  }
}
